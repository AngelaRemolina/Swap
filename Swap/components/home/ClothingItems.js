...
export const clothes_list = [
  {
    ...
    img_url:
      "https://http2.mlstatic.com/D_NQ_NP_893128-MCO46091066888_052021-W.jpg",
    categories: ["Camisas"],
    price: 20000,
    size: 12,
    color: "Blanco",
  ...
  },
  {
    name: "Jean de Gef",
    img_url:
      "https://falabella.scene7.com/is/image/FalabellaCO/3794189_1?wid=800&hei=800&qlt=70",
    categories: ["Jean"],
    price: 65000,
    size: 13,
    color: "Blanco",
...
const ClothingInfo = (props) => (
  ...
  >
    ...
    <Text id="price" style={{ fontSize: 13, color: "gray" }}>
      {props.price}
    </Text>
  </View>
);
